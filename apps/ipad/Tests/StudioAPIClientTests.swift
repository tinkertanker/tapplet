...
final class StudioAPIClientTests: XCTestCase {
    func testArtifactGETDecodesDirectArtifactThenFetchesRevisionList() async throws {
        let transport = RecordingTransport(responses: [artifactData, revisionsData])
    ...
    func testExampleSearchPostsBriefBody() async throws {
        let transport = RecordingTransport(responses: [Data("[]".utf8)])
        ...
        XCTAssertEqual(
            ...
            ["brief": "Secondary forces diagnostic"]
        )
    }
    ...
    func testPublicationRoutesPreservePatchAndDeleteContract() async throws {
        ...
        let transport = RecordingTransport(responses: [publication, Data()])
    ...
    func testAssetUploadUsesExistingHeaderContract() async throws {
        ...
        let image = PreparedWidgetImage(data: Data([1, 2, 3]), mediaType: "image/jpeg", width: 10, height: 20, sha256: "hash")
    ...
    private func client(_ transport: RecordingTransport) -> StudioAPIClient {
        StudioAPIClient(baseURL: URL(string: "https://studio.example/")!, transport: transport, tokenStore: TestTokenStore())
    }

    private var artifactData: Data { Data(#"{"id":"a1","title":"Forces","summary":"Check forces","tags":[],"creationBrief":"brief","headRevisionId":"r1","createdAt":"2026-08-02T00:00:00.123Z","updatedAt":"2026-08-02T00:00:00Z","headRevision":{"id":"r1","artifactId":"a1","sourceHash":"abc","byteLength":50,"kind":"revise","instruction":"Larger labels","model":"model","promptVersion":"1","createdAt":"2026-08-02T00:00:00Z"},"html":"<html><img src=\"assets/image-1\"></html>"}"#.utf8) }
    private var revisionsData: Data { Data(#"[{"id":"r1","artifactId":"a1","sourceHash":"abc","byteLength":50,"kind":"revise","instruction":"Larger labels","model":"model","promptVersion":"1","createdAt":"2026-08-02T00:00:00Z"}]"#.utf8) }
}
